...
public class Nave
{
	...
	public Nave(int tipoNave, float lunghezza, float larghezza, Date dataArrivo, int numeroPosizioneAttracco, String compagnia, GregorianCalendar tempoDiPermanenza)
	{
	...
	public int getTipoNave() { return tipoNave; }
	public void setTipoNave(int tipoNave) { this.tipoNave = tipoNave; }
	...
	public int getNumeroPosizioneAttracco() { return numeroPosizioneAttracco; }
	public void setNumeroPosizioneAttracco(int numeroPosizioneAttracco) { this.numeroPosizioneAttracco = numeroPosizioneAttracco; }
	public String getCompagnia() { return compagnia; }
	public void setCompagnia(String compagnia) { this.compagnia = compagnia; }
	public GregorianCalendar getTempoDiPermanenza() { return tempoDiPermanenza; }
	public void setTempoDiPermanenza(GregorianCalendar tempoDiPermanenza) { this.tempoDiPermanenza = tempoDiPermanenza; }
